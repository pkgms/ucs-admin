...
.t-container-navbar {
  ...
  .t-container-one::-webkit-scrollbar {
    /*隐藏滚轮*/
    display: none;
  }
  .t-container-tow {
...
export default class Navbar extends Vue {
  ...
  private manageSysRoleMenuUser(id: string) {
    manageSysRoleMenuUserId(id).then((res: any) => {
      if (res.code == 0) {
        //装载所有导航
        let att: any = [];
